    ...
    public class ProstheticNoMissingBodyPartsMod : Mod
    {
        ...
        private void Init()
        {
            ...
            foreach (var recipeDef in DefDatabase<RecipeDef>.AllDefs)
            {
                ...
                // catch arm
                if (recipeDef.appliedOnFixedBodyParts.Exists((x) => x.defName.Equals("Shoulder") || x.defName.Equals("Hand")))
                {
                ...
                // catch leg
                if (recipeDef.appliedOnFixedBodyParts.Exists((x) => x.defName.Equals("Leg") || x.defName.Equals("Foot")))
                {
